...
The current app supports email authentication, team creation/selection, service creation/listing, and read-only service details. Native session data is encrypted locally; sign-in still needs on-device verification. The full roster, notes, and setlist editing workflows are next.
